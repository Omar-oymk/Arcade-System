...
namespace Projectt
{
    public partial class FlappyDemon : Form
    {
        ...
        public FlappyDemon()
        {
            ...
            drums = new SoundPlayer(@"Music\Drums.wav");
            drums.Play();
        ...
        {
            if (!System.IO.File.Exists(unityExePath))       // FIRST CHECK IF THE GAME IS IN THE PATH
            {
                MessageBox.Show("Unity game not found at:\n" + unityExePath);
                return;
            }
        ...
        private void FlappyDemon_Load(object sender, EventArgs e)
        {
            ...
            string unityGamePath = @"Base_Game\FlappyDemon.exe"; // Replace this
